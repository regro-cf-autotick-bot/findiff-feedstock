...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/findiff-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12526&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/findiff-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `findiff` can be installed with:

```
conda install findiff
```

It is possible to list all of the versions of `findiff` available on your platform with:
